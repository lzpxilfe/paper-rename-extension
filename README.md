...
### 7. 🎨 아기자기한 슬림 UI & Absolute Overlay 복사 버튼
...
현재 인용식 렌더링, 파일명 정리, 다운로드 context 매칭, 각 지원처 fixture 기반 메타데이터 추출, JSON-LD 파싱, 도메인 필터링 등을 포함한 **총 104개의 단위 테스트**가 포함되어 있습니다.
